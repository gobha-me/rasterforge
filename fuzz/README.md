...
`corpus/decode/` is generated from the exact PNG, JPEG, and WebP fixtures used
by the unit suites. It contains minimal valid baseline/progressive JPEG, static
